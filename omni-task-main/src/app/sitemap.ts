...
const STATIC_PATHS: {
  ...
  { path: '/branze', changeFrequency: 'monthly', priority: 0.7, plOnly: true },
  { path: '/branze/biura-nieruchomosci', changeFrequency: 'monthly', priority: 0.7, plOnly: true },
  { path: '/branze/biura-rachunkowe', changeFrequency: 'monthly', priority: 0.7, plOnly: true },
  { path: '/branze/handel-i-ecommerce', changeFrequency: 'monthly', priority: 0.7, plOnly: true },
